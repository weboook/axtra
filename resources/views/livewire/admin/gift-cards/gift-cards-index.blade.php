...
<style>
    ...
    /* Mobile optimizations for admin gift cards page */
    @media (max-width: 768px) {
        ...
        .d-flex.align-items-center code {
            font-size: 0.8rem !important;
        }
        
        /* Gift card info mobile layout */
        ...
        /* Recent transactions table mobile */
        .table-sm th,
        .table-sm td {
        ...
        /* Recent transactions - hide some columns */
    ...
    @media (max-width: 576px) {
        ...
        /* Recent transactions table more compact */
        .table-sm {
            min-width: 500px;
        }
    ...
    @media (max-width: 480px) {
        /* Hide gift card code column on very small screens */
        ...
        /* Recent transactions most compact */
        .table-sm {
            min-width: 400px;
        }
        
        /* Gift card info smaller */
        .fw-semibold.text-dark {
            font-size: 0.8rem !important;
        }
    ...
    /* Gift card-specific mobile optimizations */
    @media (max-width: 768px) {
        ...
        /* Gift card code styling maintained */
        code {
        ...
        /* Progress bar colors maintained */
