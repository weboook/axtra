...
<style>
    ...
    /* Mobile optimizations for admin coupons page */
    @media (max-width: 768px) {
        ...
        /* Recent usage - hide some columns */
    ...
    @media (max-width: 576px) {
        ...
        /* Recent usage table more compact */
        .table-sm {
            min-width: 500px;
        }
    ...
    @media (max-width: 480px) {
        /* Hide coupon code column on very small screens */
    ...
    /* Coupon-specific mobile optimizations */
    @media (max-width: 768px) {
        ...
        /* Coupon code styling maintained */
        code {
